...
var Sentry = function(n) {
    ...
    var O = {};
    function T() {
        return S() ? global : "undefined" != typeof window ? window : "undefined" != typeof self ? self : O
    }
    function D() {
        var n = T()
    ...
    function I(n) {
        ...
        ["debug", "info", "warn", "error", "log", "assert"].forEach(function(n) {
            n in t.console && r[n].__sentry_original__ && (e[n] = r[n],
            r[n] = r[n].__sentry_original__)
        });
        var i = n();
    ...
    function A(n) {
        try {
            for (var t = n, r = [], e = 0, i = 0, o = " > ".length, u = void 0; t && e++ < 5 && !("html" === (u = U(t)) || e > 1 && i + r.length * o + u.length >= 80); )
                r.push(u),
                i += u.length,
                t = t.parentNode;
      ...
      , P = function() {
        if (S())
            try {
                return (n = module,
                t = "perf_hooks",
                n.require(t)).performance
            } catch (n) {
                return H
            }
        var n, t;
        return T().performance && void 0 === performance.timeOrigin && (performance.timeOrigin = performance.timing && performance.timing.navigationStart || q),
        T().performance || H
    }();
    function F() {
    ...
    function X(n, t) {
        ...
        if (!isNaN(r))
            return 1e3 * r;
        var e = Date.parse("" + t);
        return isNaN(e) ? W : e - n
    }
    var B = "<anonymous>";
    function $(n) {
        try {
            return n && "function" == typeof n && n.name || B
        } catch (n) {
            return B
        }
    }
      ...
      , z = function() {
        ...
        n.prototype.error = function() {
            for (var n = [], t = 0; t < arguments.length; t++)
                n[t] = arguments[t];
            this.t && I(function() {
                G.console.error(J + "[Error]: " + n.join(" "))
            })
        }
        ,
        n
    ...
    var V, K = G.__SENTRY__.logger || (G.__SENTRY__.logger = new z), Q = function() {
        function n() {
        ...
        return n.prototype.memoize = function(n) {
            if (this.i)
                return !!this.o.has(n) || (this.o.add(n),
                !1);
            for (var t = 0; t < this.o.length; t++) {
                if (this.o[t] === n)
                    return !0
            }
            return this.o.push(n),
            !1
        }
        ,
    ...
    function Z(n) {
        ...
        if (w(n)) {
            ...
            o.type = i.type;
            try {
                o.target = g(i.target) ? A(i.target) : Object.prototype.toString.call(i.target)
            } catch (n) {
                o.target = "<unknown>"
            }
            try {
                o.currentTarget = g(i.currentTarget) ? A(i.currentTarget) : Object.prototype.toString.call(i.currentTarget)
            } catch (n) {
                o.currentTarget = "<unknown>"
            }
            for (var e in "undefined" != typeof CustomEvent && x(n, CustomEvent) && (o.detail = i.detail),
            i)
    ...
    function tn(n, t, r) {
        ...
        void 0 === r && (r = 102400);
        var e = on(n, t);
        return nn(e) > r ? tn(n, t - 1, r) : e
    }
    function rn(n, t) {
        return "domain" === t && n && "object" == typeof n && n.u ? "[Domain]" : "domainEmitter" === t ? "[DomainEmitter]" : "undefined" != typeof global && n === global ? "[Global]" : "undefined" != typeof window && n === window ? "[Window]" : "undefined" != typeof document && n === document ? "[Document]" : b(r = n) && "nativeEvent"in r && "preventDefault"in r && "stopPropagation"in r ? "[SyntheticEvent]" : "number" == typeof n && n != n ? "[NaN]" : void 0 === n ? "[undefined]" : "function" == typeof n ? "[Function: " + $(n) + "]" : n;
        var r
    }
    function en(n, t, r, e) {
        if (void 0 === r && (r = 1 / 0),
        ...
        if (e.memoize(t))
            return "[Circular ~]";
        for (var c in o)
            Object.prototype.hasOwnProperty.call(o, c) && (u[c] = en(c, o[c], r - 1, e));
    ...
    var cn = function() {
        function n(n) {
            ...
            ,
            this.l = function(n, r) {
                t.s === V.PENDING && (E(r) ? r.then(t.v, t.p) : (t.s = n,
                t.m = r,
                t.g()))
            }
            ,
            ...
            this.g = function() {
                if (t.s !== V.PENDING) {
                    ...
                    n.forEach(function(n) {
                        n.done || (t.s === V.RESOLVED && n.onfulfilled && n.onfulfilled(t.m),
                        t.s === V.REJECTED && n.onrejected && n.onrejected(t.m),
                        n.done = !0)
                    })
                }
            }
      ...
      , an = function() {
        ...
        n.prototype.add = function(n) {
            var t = this;
            return this.isReady() ? (-1 === this._.indexOf(n) && this._.push(n),
            n.then(function() {
                return t.remove(n)
            }).then(null, function() {
                return t.remove(n).then(null, function() {})
            }),
            n) : cn.reject(new v("Not adding Promise due to buffer limit reached."))
        }
        ,
        ...
        if (!pn[n])
            ...
            case "console":
                !function() {
                    if (!("console"in ln))
                        return;
                    ["debug", "info", "warn", "error", "log", "assert"].forEach(function(n) {
                        n in ln.console && Y(ln.console, n, function(t) {
                            return function() {
                                ...
                                t && Function.prototype.apply.call(t, ln.console, r)
                            }
                        })
                    })
                }();
            ...
            case "dom":
                !function() {
                    if (!("document"in ln))
                        return;
                    ln.document.addEventListener("click", _n("click", bn.bind(null, "dom")), !1),
                    ln.document.addEventListener("keypress", Sn(bn.bind(null, "dom")), !1),
                    ["EventTarget", "Node"].forEach(function(n) {
                        var t = ln[n] && ln[n].prototype;
                        t && t.hasOwnProperty && t.hasOwnProperty("addEventListener") && (Y(t, "addEventListener", function(n) {
                            return function(t, r, e) {
                                return r && r.handleEvent ? ("click" === t && Y(r, "handleEvent", function(n) {
                                    return function(t) {
                                        return _n("click", bn.bind(null, "dom"))(t),
                                        n.call(this, t)
                                    }
                                }),
                                "keypress" === t && Y(r, "handleEvent", function(n) {
                                    return function(t) {
                                        return Sn(bn.bind(null, "dom"))(t),
                                        n.call(this, t)
                                    }
                                })) : ("click" === t && _n("click", bn.bind(null, "dom"), !0)(this),
                                "keypress" === t && Sn(bn.bind(null, "dom"))(this)),
                                n.call(this, t, r, e)
                            }
                        }),
                        Y(t, "removeEventListener", function(n) {
                            return function(t, r, e) {
                                var i = r;
                                try {
                    ...
                    if (!function() {
                        ...
                        if (r && "function" == typeof r.createElement)
                            try {
                                ...
                                e.contentWindow && e.contentWindow.fetch && (t = fn(e.contentWindow.fetch)),
                                r.head.removeChild(e)
                            } catch (n) {
                                K.warn("Could not create sandbox iframe for pure fetch check, bailing to window.fetch: ", n)
                            }
                        return t
                    }())
                        return;
                    Y(ln, "fetch", function(n) {
                        return function() {
                            for (var t = [], r = 0; r < arguments.length; r++)
                                t[r] = arguments[r];
                            var i = {
            ...
            case "history":
                !function() {
                    ...
                    e = "history"in n && !!n.history.pushState && !!n.history.replaceState,
                    r || !e)
                        return;
                    var n, t, r, e;
                    var i = ln.onpopstate;
                    ...
                    ln.onpopstate = function() {
                        for (var n = [], t = 0; t < arguments.length; t++)
                            n[t] = arguments[t];
                        var r = ln.location.href
                          , e = vn;
                        if (vn = r,
                        bn("history", {
                            from: e,
                    ...
                    ,
                    Y(ln.history, "pushState", o),
                    Y(ln.history, "replaceState", o)
                }();
                break;
            case "error":
                On = ln.onerror,
                ln.onerror = function(n, t, r, e, i) {
                    return bn("error", {
                        column: e,
                        error: i,
                        line: r,
                    ...
                    !!On && On.apply(this, arguments)
                }
                ;
                break;
            case "unhandledrejection":
                Tn = ln.onunhandledrejection,
                ln.onunhandledrejection = function(n) {
                    return bn("unhandledrejection", n),
                    !Tn || Tn.apply(this, arguments)
                }
                ;
                break;
            default:
                K.warn("unknown instrumentation type:", n)
            }
    }
    function mn(n) {
        n && "string" == typeof n.type && "function" == typeof n.callback && (dn[n.type] = dn[n.type] || [],
        dn[n.type].push(n.callback),
        yn(n.type))
    }
    function bn(n, t) {
        var r, e;
        if (n && dn[n])
            try {
                for (var o = i(dn[n] || []), u = o.next(); !u.done; u = o.next()) {
                    var c = u.value;
                    try {
                        c(t)
                    } catch (t) {
    ...
    function wn(n) {
        return void 0 === n && (n = []),
        "Request"in ln && x(n[0], Request) && n[0].method ? String(n[0].method).toUpperCase() : n[1] && n[1].method ? String(n[1].method).toUpperCase() : "GET"
    }
    function gn(n) {
        return void 0 === n && (n = []),
        "string" == typeof n[0] ? n[0] : "Request"in ln && x(n[0], Request) ? n[0].url : String(n[0])
    }
    var En, xn, jn = 1e3, kn = 0;
    function _n(n, t, r) {
        return void 0 === r && (r = !1),
        function(e) {
            En = void 0,
    ...
    function Sn(n) {
        return function(t) {
            ...
            var e = r && r.tagName;
            e && ("INPUT" === e || "TEXTAREA" === e || r.isContentEditable) && (En || _n("input", n)(t),
            clearTimeout(En),
    ...
    var Dn = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+))?@)([\w\.-]+)(?::(\d+))?\/(.+)/
      ...
      , Nn = function() {
        ...
        n.prototype.applyToEvent = function(n, t) {
            return this.A && Object.keys(this.A).length && (n.extra = e({}, this.A, n.extra)),
            this.M && Object.keys(this.M).length && (n.tags = e({}, this.M, n.tags)),
            this.C && Object.keys(this.C).length && (n.user = e({}, this.C, n.user)),
            this.U && Object.keys(this.U).length && (n.contexts = e({}, this.U, n.contexts)),
    ...
    var Mn = 3
      , An = function() {
        ...
        n.prototype.captureException = function(n, t) {
            ...
            return this.G("captureException", n, e({}, i, {
                event_id: r
            })),
            r
        }
        ...
        n.prototype.captureMessage = function(n, t, r) {
            ...
            return this.G("captureMessage", n, t, e({}, o, {
                event_id: i
            })),
            i
        }
        ...
        n.prototype.captureEvent = function(n, t) {
            var r = this.J = D();
            return this.G("captureEvent", n, e({}, t, {
                event_id: r
            })),
            r
        }
        ...
        n.prototype.getIntegration = function(n) {
            ...
            try {
                ...
                return K.warn("Cannot retrieve integration " + n.id + " from the current Hub"),
                null
            }
        }
        ,
        ...
        n.prototype.V = function(n) {
            for (var t = [], r = 1; r < arguments.length; r++)
                t[r - 1] = arguments[r];
            var e = Un().__SENTRY__;
            if (e && e.extensions && "function" == typeof e.extensions[n])
                return e.extensions[n].apply(this, t);
            K.warn("Extension method " + n + " couldn't be found, doing nothing.")
        }
        ,
        n
    }();
    ...
    function Ln() {
        var n = Un();
        return Hn(n) && !Pn(n).isOlderThan(Mn) || Fn(n, new An),
        S() ? function(n) {
            try {
                var t = Un()
                  , r = t.__SENTRY__;
                if (!r || !r.extensions || !r.extensions.domain)
                    return Pn(n);
                var e = r.extensions.domain
                  , i = e.active;
                if (!i)
                    return Pn(n);
                if (!Hn(i) || Pn(i).isOlderThan(Mn)) {
                    var o = Pn(n).getStackTop();
                    Fn(i, new An(o.client,Nn.clone(o.scope)))
                }
                return Pn(i)
            } catch (t) {
                return Pn(n)
    ...
    var Bn = function() {
        ...
        n.prototype.getStoreEndpointWithUrlEncodedAuth = function() {
            ...
            return this.getStoreEndpoint() + "?" + (n = t,
        ...
        n.prototype.getReportDialogEndpoint = function(n) {
            ...
            var t = this.K
              ...
              , e = [];
            for (var i in e.push("dsn=" + t.toString()),
            n)
                if ("user" === i) {
                    if (!n.user)
                        continue;
        ...
        return function(n) {
            ...
            if (Array.isArray(r)) {
                ...
                t.forEach(function(n) {
                    -1 === i.indexOf(n.name) && -1 === o.indexOf(n.name) && (e.push(n),
                    o.push(n.name))
                }),
                r.forEach(function(n) {
                    -1 === o.indexOf(n.name) && (e.push(n),
                    o.push(n.name))
                })
            } else
                "function" == typeof r ? (e = r(t),
                e = Array.isArray(e) ? e : [e]) : e = u(t);
            ...
            t[n.name] = n,
            function(n) {
                -1 === $n.indexOf(n.name) && (n.setupOnce(Cn, Ln),
                $n.push(n.name),
                K.log("Integration installed: " + n.name))
            }(n)
        }),
        t
    }
    var Jn, zn = function() {
        ...
        n.prototype.getIntegration = function(n) {
            try {
                ...
                return K.warn("Cannot retrieve integration " + n.id + " from the current Client"),
                null
            }
        }
        ,
        ...
        n.prototype.an = function(n, t, r) {
            ...
            void 0 === l.event_id && (l.event_id = r && r.event_id ? r.event_id : D()),
            this.sn(l.sdk);
            var y = cn.resolve(l);
        ...
        n.prototype.on = function(n, t, r) {
            var e = this
              ...
              , o = i.beforeSend
              , u = i.sampleRate;
            return this.cn() ? "number" == typeof u && Math.random() > u ? cn.reject("This event has been sampled, will not send event.") : new cn(function(i, u) {
                e.an(n, r, t).then(function(n) {
                    if (null !== n) {
                        var r = n;
                        if (t && t.data && !0 === t.data.__sentry__ || !o)
                            return e.in().sendEvent(r),
                            void i(r);
                        var c = o(n, t);
                        if (void 0 === c)
                            ...
                            if (null === (r = c))
                                return K.log("`beforeSend` returned `null`, will not send event."),
                                void i(null);
                            e.in().sendEvent(r),
                            i(r)
                        }
            ...
            ) : cn.reject("SDK not enabled, will not send event.")
        }
        ,
        n.prototype.hn = function(n, t, r) {
            var e = this;
            n.then(function(n) {
                null !== n ? (e.in().sendEvent(n),
                t(n)) : r("`beforeSend` returned `null`, will not send event.")
            }).then(null, function(n) {
        ...
        function n(n) {
            this.rn = n,
            this.rn.dsn || K.warn("No DSN provided, backend will not do anything."),
            this.vn = this.ln()
        }
        ...
        n.prototype.sendEvent = function(n) {
            this.vn.sendEvent(n).then(null, function(n) {
    ...
    var Qn = function() {
      ...
      , Yn = [/^Script error\.?$/, /^Javascript error: Script error\.? on line 0$/]
      , Zn = function() {
        function n(t) {
            void 0 === t && (t = {}),
            this.rn = t,
        ...
        n.prototype.pn = function(n, t) {
            return this.yn(n, t) ? (K.warn("Event dropped due to being internal Sentry Error.\nEvent: " + N(n)),
            !0) : this.mn(n, t) ? (K.warn("Event dropped due to being matched by `ignoreErrors` option.\nEvent: " + N(n)),
            !0) : this.bn(n, t) ? (K.warn("Event dropped due to being matched by `blacklistUrls` option.\nEvent: " + N(n) + ".\nUrl: " + this.wn(n)),
            !0) : !this.gn(n, t) && (K.warn("Event dropped due to not being matched by `whitelistUrls` option.\nEvent: " + N(n) + ".\nUrl: " + this.wn(n)),
            !0)
        }
        ,
        ...
        n.prototype.mn = function(n, t) {
            return void 0 === t && (t = {}),
            !(!t.ignoreErrors || !t.ignoreErrors.length) && this.En(n).some(function(n) {
        ...
        n.prototype.dn = function(n) {
            return void 0 === n && (n = {}),
            {
                ...
                ignoreErrors: u(this.rn.ignoreErrors || [], n.ignoreErrors || [], Yn),
        ...
        n.prototype.En = function(n) {
            ...
            if (n.exception)
                try {
                    ...
                    return K.error("Cannot extract message for event " + N(n)),
                    []
                }
            return []
        }
        ...
        n.prototype.wn = function(n) {
            try {
                ...
                return K.error("Cannot extract url for event " + N(n)),
                null
            }
        }
        ,
      ...
      , ot = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i
      , ut = /\((\S*)(?::(\d+))(?::(\d+))\)/;
    function ct(n) {
        var t = null
          , r = n && n.framesToPop;
        try {
            if (t = function(n) {
                if (!n || !n.stacktrace)
                    return null;
                for (var t, r = n.stacktrace, e = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i, i = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^\)]+))\((.*)\))? in (.*):\s*$/i, o = r.split("\n"), u = [], c = 0; c < o.length; c += 2) {
                    var a = null;
                    (t = e.exec(o[c])) ? a = {
                        url: t[2],
                        func: t[3],
            ...
            if (t = function(n) {
                ...
                for (var t, r, e, i = [], o = n.stack.split("\n"), u = 0; u < o.length; ++u) {
                    if (r = rt.exec(o[u])) {
                        ...
                        r[2] && 0 === r[2].indexOf("eval") && (t = ut.exec(r[2])) && (r[2] = t[1],
                        r[3] = t[2],
                        r[4] = t[3]),
                        e = {
                        ...
                        if (!(r = et.exec(o[u])))
                            continue;
                        r[3] && r[3].indexOf(" > eval") > -1 && (t = ot.exec(r[3])) ? (r[1] = r[1] || "eval",
                        r[3] = t[1],
                        r[4] = t[2],
                        r[5] = "") : 0 !== u || r[5] || void 0 === n.columnNumber || (i[0].column = n.columnNumber + 1),
                        e = {
                            url: r[3],
                            func: r[1] || tt,
                            args: r[2] ? r[2].split(",") : [],
    ...
    function lt(n) {
        ...
        var t = n
          , r = t[0].func || ""
          , e = t[t.length - 1].func || "";
        return -1 === r.indexOf("captureMessage") && -1 === r.indexOf("captureException") || (t = t.slice(1)),
    ...
    var yt = function() {
        function n(n) {
            this.options = n,
            this._ = new an(30),
            this.url = new Bn(this.options.dsn).getStoreEndpointWithUrlEncodedAuth()
        }
      ...
      , bt = function(t) {
        ...
        e.prototype.sendEvent = function(t) {
            ...
            var e = {
                ...
                method: "POST",
                referrerPolicy: hn() ? "origin" : ""
            };
            return void 0 !== this.options.headers && (e.headers = this.options.headers),
            this._.add(new cn(function(t, i) {
                mt.fetch(r.url, e).then(function(e) {
                    var o = n.Status.fromHttpCode(e.status);
                    if (o !== n.Status.Success) {
                        if (o === n.Status.RateLimit) {
                            var u = Date.now();
                            r.xn = new Date(u + X(u, e.headers.get("Retry-After"))),
                            K.warn("Too many requests, backing off till: " + r.xn)
                        }
                        i(e)
                    } else
                        t({
      ...
      , wt = function(t) {
        ...
        e.prototype.sendEvent = function(t) {
            ...
            return new Date(Date.now()) < this.xn ? Promise.reject({
                ...
                reason: "Transport locked till " + this.xn + " due to too many requests.",
                status: 429
            }) : this._.add(new cn(function(e, i) {
                    ...
                    if (4 === o.readyState) {
                        ...
                        if (t !== n.Status.Success) {
                            if (t === n.Status.RateLimit) {
                                var u = Date.now();
                                r.xn = new Date(u + X(u, o.getResponseHeader("Retry-After"))),
                                K.warn("Too many requests, backing off till: " + r.xn)
                            }
                            i(o)
                        } else
      ...
      , Et = function(t) {
        ...
        i.prototype.ln = function() {
            if (!this.rn.dsn)
                return t.prototype.ln.call(this);
            var n = e({}, this.rn.transportOptions, {
                dsn: this.rn.dsn
            });
            return this.rn.transport ? new this.rn.transport(n) : sn() ? new bt(n) : new wt(n)
        }
        ,
        i.prototype.eventFromException = function(t, r) {
            var e = dt(t, r && r.syntheticException || void 0, {
        ...
        i.prototype.eventFromMessage = function(t, r, e) {
            ...
            var i = pt(t, e && e.syntheticException || void 0, {
                attachStacktrace: this.rn.attachStacktrace
            });
            return i.level = r,
      ...
      , xt = "sentry.javascript.browser"
      , jt = function(n) {
        function t(t) {
            return void 0 === t && (t = {}),
            n.call(this, Et, t) || this
        }
        return r(t, n),
                ...
                if (this.cn()) {
                    ...
                    if (n.eventId)
                        if (r) {
                            ...
                            e.async = !0,
                            e.src = new Bn(r).getReportDialogEndpoint(n),
                            n.onLoad && (e.onload = n.onLoad),
                            (t.head || t.body).appendChild(e)
                        } else
                            K.error("Missing `Dsn` option in showReportDialog call");
                    else
                        K.error("Missing `eventId` option in showReportDialog call")
                } else
                    K.error("Trying to call showReportDialog with Sentry Client is disabled")
        }
        ,
        t
    }(zn)
            ...
            try {
                ...
                Xn(function(r) {
                    r.addEventProcessor(function(n) {
                        var r = e({}, n);
                        return t.mechanism && (C(r, void 0, void 0),
                        M(r, t.mechanism)),
                        r.extra = e({}, r.extra, {
                            arguments: i
                        }),
    ...
    var Ot = function() {
        ...
        return t.prototype.setupOnce = function() {
            ...
            this.rn.onerror && (K.log("Global Handler attached: onerror"),
            this._n()),
            this.rn.onunhandledrejection && (K.log("Global Handler attached: onunhandledrejection"),
            this.Sn())
        }
        ,
        t.prototype._n = function() {
            ...
            this.jn || (mn({
                callback: function(r) {
                    ...
                    if (o && !_t() && !u) {
                        var c = i.getClient()
                          , a = m(e) ? n.On(r.msg, r.url, r.line, r.column) : n.Tn(dt(e, void 0, {
      ...
      , Tt = function() {
        ...
        n.prototype.Cn = function(n) {
            var t = T()
              , r = t[n] && t[n].prototype;
            r && r.hasOwnProperty && r.hasOwnProperty("addEventListener") && (Y(r, "addEventListener", function(t) {
                return function(r, e, i) {
                    try {
                        "function" == typeof e.handleEvent && (e.handleEvent = St(e.handleEvent.bind(e), {
                            mechanism: {
                                data: {
            ...
            Y(r, "removeEventListener", function(n) {
                return function(t, r, e) {
                    var i = r;
                    try {
                        i = i && (i.__sentry_wrapped__ || i)
        ...
        n.prototype.Mn = function(n) {
            return function() {
                ...
                return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach(function(n) {
                    n in e && "function" == typeof e[n] && Y(e, n, function(t) {
                        var r = {
                            mechanism: {
                                data: {
                                    function: n,
                        ...
                        return t.__sentry_original__ && (r.mechanism.data.handler = $(t.__sentry_original__)),
                        St(t, r)
                    })
                }),
                n.apply(this, t)
        ...
        n.prototype.setupOnce = function() {
            this.Rn = this.Rn;
            var n = T();
            Y(n, "setTimeout", this.Nn.bind(this)),
            Y(n, "setInterval", this.Nn.bind(this)),
            Y(n, "requestAnimationFrame", this.In.bind(this)),
            "XMLHttpRequest"in n && Y(XMLHttpRequest.prototype, "send", this.Mn.bind(this)),
            ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"].forEach(this.Cn.bind(this))
        }
        ,
        n.id = "TryCatch",
        n
      ...
      , Dt = function() {
        ...
        t.prototype.Un = function(n) {
            var t;
            try {
                t = n.event.target ? A(n.event.target) : A(n.event)
            } catch (n) {
                t = "<unknown>"
            }
            0 !== t.length && Ln().addBreadcrumb({
                category: "ui." + n.name,
                message: t
            }, {
                event: n.event,
        ...
        t.prototype.qn = function(n) {
            if (n.endTimestamp) {
                if (n.xhr.__sentry_own_request__)
                    return;
                Ln().addBreadcrumb({
                    category: "xhr",
                ...
                this.rn.sentry && n.xhr.__sentry_own_request__ && Rt(n.args[0])
        }
        ,
        t.prototype.Ln = function(t) {
            if (t.endTimestamp) {
                var r = Ln().getClient()
                  , i = r && r.getDsn();
                if (this.rn.sentry && i) {
                    var o = new Bn(i).getStoreEndpoint();
                    if (o && -1 !== t.fetchData.url.indexOf(o) && "POST" === t.fetchData.method && t.args[1] && t.args[1].body)
                        return void Rt(t.args[1].body)
                }
                t.error ? Ln().addBreadcrumb({
                    category: "fetch",
                    data: e({}, t.fetchData, {
    ...
    var Nt = "cause"
      ...
      , Ct = function() {
        ...
        return n.prototype.setupOnce = function() {
            Cn(function(t, r) {
                var e = Ln().getIntegration(n);
                return e ? e.Fn(t, r) : t
            })
        }
        ,
        n.prototype.Fn = function(n, t) {
            if (!(n.exception && n.exception.values && t && x(t.originalException, Error)))
                return n;
      ...
      , At = function() {
        ...
        return n.prototype.setupOnce = function() {
            Cn(function(t) {
                if (Ln().getIntegration(n)) {
                    if (!Mt.navigator || !Mt.location)
                        return t;
                    var r = t.request || {};
                    return r.url = r.url || Mt.location.href,
                    r.headers = r.headers || {},
                    r.headers["User-Agent"] = Mt.navigator.userAgent,
                    e({}, t, {
                        request: r
                    })
                }
      ...
      , qt = [new Zn, new Qn, new Tt, new Dt, new Ot, new Ct, new At];
    var Lt = {}
      , Ht = T();
    Ht.Sentry && Ht.Sentry.Integrations && (Lt = Ht.Sentry.Integrations);
    var Pt = e({}, Lt, nt, Ut);
    return n.BrowserClient = jt,
    n.Hub = An,
    n.Integrations = Pt,
    n.SDK_NAME = xt,
    n.SDK_VERSION = "5.15.4",
    n.Scope = Nn,
    n.Transports = gt,
    ...
    ,
    n.addGlobalEventProcessor = Cn,
    n.captureEvent = function(n) {
        return Wn("captureEvent", n)
    }
    ,
    ...
    n.close = function(n) {
        var t = Ln().getClient();
        return t ? t.close(n) : cn.reject(!1)
    }
    ,
    ...
    ,
    n.defaultIntegrations = qt,
    n.flush = function(n) {
        var t = Ln().getClient();
        return t ? t.flush(n) : cn.reject(!1)
    }
    ,
    n.forceLoad = function() {}
    ,
    n.getCurrentHub = Ln,
    n.getHubFromCarrier = Pn,
    n.init = function(n) {
        if (void 0 === n && (n = {}),
        void 0 === n.defaultIntegrations && (n.defaultIntegrations = qt),
        void 0 === n.release) {
            var t = T();
    ...
    n.showReportDialog = function(n) {
        void 0 === n && (n = {}),
        n.eventId || (n.eventId = Ln().lastEventId());
        var t = Ln().getClient();
